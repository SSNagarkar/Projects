    ...
    const home_nav = home.map( item => {
        return(
            <li className="home-nav" key = {item.name} >      
                <a onClick={onNav} className="home-nav-link" href="{item.path}" data-target={item.name}>Home Page
                </a>
            </li>
   ...
   const  handleChange = (event) => {
    ...
    return(
        <div className="reservation-form">
            ...
            <form id="reservation-root-form" onSubmit={handleSubmit} method="POST">
                <div className="reservation-form-contents">
                    ...
                    <input className="name-input" type="text" name="uname" 
                    ...
                    <input className="email-input" type="text" name="mail" 
                    ...
                    <input className="phone-input" type="text" name="p_number" 
                    ...
                    <label className="checkbox"> Want to receive your confirmation on email?
        ...
        >Your Reservation is successfull!</div>) : (<div className='error-message'>Please enter required details</div>)}
                        ...
                        <p className='home-nav-text'>Navigate to {home_nav}</p>
